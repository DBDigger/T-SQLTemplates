...
/*------------------------------------------------------------------
Analysis of backup files for size growth
-------------------------------------------------------------------*/
SELECT [database_name] AS "Database", [backup_start_date], 
convert(NUMERIC(10, 3), AVG([backup_size] / 1024 / 1024)) AS "Backup Size MB"
FROM msdb.dbo.backupset
WHERE [database_name] = N'MBA'
AND [type] = 'D'
