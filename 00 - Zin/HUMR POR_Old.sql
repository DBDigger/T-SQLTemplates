...
join CONTACTS c with (nolock) on c.CONTACTID = b.BILLINGADDRESSID_FK
...
where cmp.orgid <> 5015 
or cmp.parentorgid_fk <> 5015
group by cmp.COMPLETENAME ,
       ...
       i.currencycode_fk
HAVING 
SUM(ISNULL(ii.SERVICECHARGE,0)-ISNULL(ii.DISCOUNT,0)) * cr.CONVERSIONRATE >50  
