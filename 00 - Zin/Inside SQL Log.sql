...
t.ApplicationName , t.LoginName , t.SPID , t.Duration ,  t.StartTime ,t.EndTime
...
-- return the log growths and log shrinking.
SELECT TE.NAME AS [EventName]	,T.DatabaseName	,t.DatabaseID	,t.NTDomainName	,t.ApplicationName
	,t.LoginName	,t.SPID	,t.Duration	,t.StartTime	,t.EndTime
FROM sys.fn_trace_gettable(CONVERT(VARCHAR(150), (
				SELECT TOP 1 f.[value]
				FROM sys.fn_trace_getinfo(NULL) f
				WHERE f.property = 2
...
-- outline the errors:
SELECT TE.NAME AS [EventName]	,T.DatabaseName	,t.DatabaseID	,t.NTDomainName	,t.ApplicationName	,t.LoginName
	,t.SPID	,t.StartTime	,t.TextData	,t.Severity	,t.Error
FROM sys.fn_trace_gettable(CONVERT(VARCHAR(150), (
				SELECT TOP 1 f.[value]
				FROM sys.fn_trace_getinfo(NULL) f
				WHERE f.property = 2
...
-- outline the sort and hash warnings:
SELECT TE.NAME AS [EventName] ,v.subclass_name ,T.DatabaseName ,t.DatabaseID ,t.NTDomainName
	,t.ApplicationName	,t.LoginName	,t.SPID	,t.StartTime
FROM sys.fn_trace_gettable(CONVERT(VARCHAR(150), (
				SELECT TOP 1 f.[value]
				FROM sys.fn_trace_getinfo(NULL) f
				WHERE f.property = 2
...
-- script which outlines the missing STATISTICS	AND JOIN predicates.
...
WHERE te.NAME = 'Missing Column Statistics'
	...
	--what users have been created on our SQL Server instance:
SELECT TE.NAME AS [EventName] 	,v.subclass_name	,T.DatabaseName	,t.DatabaseID	,t.NTDomainName	,t.ApplicationName
	,t.LoginName	,t.SPID	,t.StartTime	,t.RoleName	,t.TargetUserName	,t.TargetLoginName	,t.SessionLoginName
FROM sys.fn_trace_gettable(CONVERT(VARCHAR(150), (
				SELECT TOP 1 f.[value]
				FROM sys.fn_trace_getinfo(NULL) f
				WHERE f.property = 2
...
WHERE te.NAME IN (
	...
	AND v.subclass_name IN (
		...
		--audit the dropped users and logins by running the following query:
SELECT TE.NAME AS [EventName]	,v.subclass_name	,T.DatabaseName	,t.DatabaseID	,t.NTDomainName	,t.ApplicationName
	,t.LoginName	,t.SPID	,t.StartTime	,t.RoleName	,t.TargetUserName	,t.TargetLoginName	,t.SessionLoginName
FROM sys.fn_trace_gettable(CONVERT(VARCHAR(150), (
				SELECT TOP 1 f.[value]
...
WHERE te.NAME IN (
	...
	AND v.subclass_name IN (
		...
		--all the failed logins contained in our default trace file:
SELECT TE.NAME AS [EventName]	,v.subclass_name	,T.DatabaseName	,t.DatabaseID	,t.NTDomainName	,t.ApplicationName
	,t.LoginName	,t.SPID	,t.StartTime	,t.SessionLoginName
FROM sys.fn_trace_gettable(CONVERT(VARCHAR(150), (
				SELECT TOP 1 f.[value]
				FROM sys.fn_trace_getinfo(NULL) f
				WHERE f.property = 2
...
--server start event:
SELECT TE.NAME AS [EventName]
	,v.subclass_name 	,T.DatabaseName	,t.DatabaseID	,t.NTDomainName	,t.ApplicationName	,t.LoginName	,t.SPID	,t.StartTime	,t.SessionLoginName
FROM sys.fn_trace_gettable(CONVERT(VARCHAR(150), (
				SELECT TOP 1 f.[value]
				FROM sys.fn_trace_getinfo(NULL) f
				WHERE f.property = 2
...
--tell us when the memory use has changed:
SELECT TE.NAME AS [EventName]
	,v.subclass_name
	,t.IsSystem
FROM sys.fn_trace_gettable(CONVERT(VARCHAR(150), (
...
WHERE TE.NAME IN (
	...
	AND StartTime > DATEADD(HH, - 24, GETDATE()) ORDERBY t.StartTime DESC;